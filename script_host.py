...
# Admin panel HTML (truncated for brevity - same as botstuff version)
ADMIN_TEMPLATE = """[Same admin template as in botstuff/script_host.py]"""
...
def add_script_hosting_routes(app):
    ...
    def admin_page():
        ...
        script_url = request.host_url + 'api/script/raw'
        return "Admin panel - Full template in botstuff/script_host.py"
